...
官方目录已加入 GPT-6 Sol 和 Luna，并说明推出期间 GPT-5.6 系列仍可用。场景表中的 GPT-5.6 组合可作既有环境的对照；新用户先核对当前目录，再用同一任务验证新候选，不能只凭换代认定效果更好。[官方模型目录](https://learn.chatgpt.com/docs/models.md)
